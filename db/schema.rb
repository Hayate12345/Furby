...
ActiveRecord::Schema.define(version: 2023_02_24_182346) do
  ...
  create_table "welfares", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["confirmation_token"], name: "index_welfares_on_confirmation_token", unique: true
    t.index ["email"], name: "index_welfares_on_email", unique: true
    t.index ["reset_password_token"], name: "index_welfares_on_reset_password_token", unique: true
